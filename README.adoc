...
We're available at link:https://npo-poms.slack.com/[slack].

Documentation is maintained at https://publiekeomroep.atlassian.net/wiki/spaces/[wiki of NPO] (needs password)
...
See link:https://npo-poms.github.io/poms-parent/presentations/POMS[here]
